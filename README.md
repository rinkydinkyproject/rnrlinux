...
* The goal here being for apples to apples benchmarks as well for research reasons.
  * given the newbie friendly aspects of immutable distros (less breakage and such), it's proving to be a great way to get people into Linux desktops without the complications that can come up for a non-technical user. Bazzite stock as is, is a GREAT gaming distro and has lots of potential to be even greater for other purposes. But as their focus is gaming, it will have less appeal for other types of users. After discussions with various non-technical users I know, they just want something that works out of the box and stays out of their way. It updates as required, minmial issues. Windows has become needlessly complex and restrictive for many of them. Currently I work off of feedback from a small willing non-technical userbase using Bazzite as a base, and the results have been interesting. The non-technical gamer has been VERY happy with Stock Bazzite, but the non-technical NON-gamer has not. So I've been working towards that side as that side comprises the bulk of PC users being iced out of the PC ecosystem by the forced obsecelence of hardware due to artificially imposed hardware restrictions. Most home users just want a PC that they can get a long life from. My goal here is to build a useable image with the baseline of, if my 85+ year old mom can use this system, then anyone can. So that requires a set of defaults that are intuitive and familiar to people rather than reinventing the wheel. There's plenty of distros out there, but IMO too few that cater to the non-technical user. The beauty of Linux is the ability to pick and choose and customize, so those who embrace the full context of the ecosystem can still go that route, while there can be a parallel niche of immutability and stability for those who require it and don't or can't easily learn how to fix problems. This is the space I'm working on this project for.
  * Text & images below will be replaced once the project has made some more progress. This project is very much pre-alpha and still planning stages. There's no commercial impetus here, this is both a hobby project and something for the community. I just want people to have better computing experience. But all credit for the underlying system belongs to everyone who is still credited below and that will not change. 
